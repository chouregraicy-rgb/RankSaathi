      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-3xl shadow-xl border border-orange-100 p-8">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 border border-gray-200 rounded-xl py-3 mb-4 text-sm font-semibold text-gray-700 hover:bg-gray-50 transition-all"
          >
