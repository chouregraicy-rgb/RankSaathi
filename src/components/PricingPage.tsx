...
const PLANS = {
  student: {
    ...
    features: [
      "114 NEET PDF Files — FREE (Biology, Chemistry, Physics)",
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-400 text-lg max-w-xl mx-auto">
            Complete NEET preparation — App + 114 PDFs + AI Tools. One payment, lifetime access.
          </p>
        ...
        <div className="flex flex-wrap justify-center gap-6 text-xs text-gray-500 mt-8">
          ...
          <span className="flex items-center gap-1.5">
            <Check className="w-3.5 h-3.5 text-blue-400" /> 114 PDFs included
          </span>
          <span className="flex items-center gap-1.5">
